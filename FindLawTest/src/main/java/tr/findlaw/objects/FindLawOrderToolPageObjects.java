...
public class FindLawOrderToolPageObjects {
	...
	@FindBy(xpath="//cob/div/div[3]/h3")
	public static WebElement lblMessage;
	
	@FindBy(xpath="//div/div[2]/div[2]/span")
	public static WebElement lblStatus;
	
	@FindBy(xpath="//div/div[1]/h2")
	public static WebElement lblCOB;
	
	@FindBy(xpath="//div[2]/timer/span/b")
	public static WebElement lblTimer;
	...
	@FindBy(xpath="//div[2]/waiting-modal/i")
	public static WebElement lblSaving;
	...
	@FindBy(xpath="//input[@id='textAnswer']/../../../../../../../../div[8]/div/question/div/answer/ul/li/select")
	public static WebElement drpdwnLegalContent2;
	...
	@FindBy(xpath="//ul[@id='notSubmitted']/li//div[1]/span")
	public static List <WebElement> drpdwnCustomerGoal3;
	...
	public static List <WebElement> txtinputs2;
	...
	public static List<WebElement> btnExpand;
	...
	@FindBy(xpath="//product/expandable[1]/div/button/span")
	public static WebElement btnExpnd;
	
	@FindBy(xpath="//product/expandable[2]/div/button/span")
	public static WebElement btnExpnd1;
	
	@FindBy(xpath="//tab[4]//product[2]//ul[1]//div/button/span")
	public static WebElement btnsubExpand1;
	
	@FindBy(xpath="//product[1]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn;
	
	@FindBy(xpath="//product[1]//ul[1]//expandable[1]/div/button/../span")
	public static WebElement Expandsubbtntitle;
	
	@FindBy(xpath="//product[1]//ul[1]//expandable[2]/div/button")
	public static WebElement Expandsubbtn1;
	
	@FindBy(xpath="//product[1]//ul[1]//expandable[2]/div/button/../span")
	public static WebElement Expandsubbtn1title;
	
	@FindBy(xpath="//product[2]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn2;
	
	@FindBy(xpath="//product[2]//ul[1]//expandable[2]/div/button")
	public static WebElement Expandsubbtn3;
	
	@FindBy(xpath="//product[3]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn4;
	
	@FindBy(xpath="//product[4]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn5;
	
	@FindBy(xpath="//product[5]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn6;
	
	@FindBy(xpath="//product[6]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn7;
	
	@FindBy(xpath="//product[7]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn8;
	
	@FindBy(xpath="//product[7]//ul[1]//expandable[2]/div/button")
	public static WebElement Expandsubbtn9;
	
	@FindBy(xpath="//product[8]//ul[1]//expandable[1]/div/button")
	public static WebElement Expandsubbtn0;
	
	@FindBy(xpath="//product[8]//ul[1]//expandable[2]/div/button")
	public static WebElement Expandsubbtn01;
	...
	public static WebElement Expandbtn1;
	
	@FindBy(xpath="//product[2]/expandable/div/button")
	public static WebElement Expandbtn2;
	
	@FindBy(xpath="//product[3]/expandable/div/button")
	public static WebElement Expandbtn3;
	
	@FindBy(xpath="//product[4]/expandable/div/button")
	public static WebElement Expandbtn4;
	
	@FindBy(xpath="//product[5]/expandable/div/button")
	public static WebElement Expandbtn5;
	
	@FindBy(xpath="//product[6]/expandable/div/button")
	public static WebElement Expandbtn6;
	
	@FindBy(xpath="//product[7]/expandable/div/button")
	public static WebElement Expandbtn7;
	
	@FindBy(xpath="//product[8]/expandable/div/button")
	public static WebElement Expandbtn8;
	...
	@FindBy(xpath="//input[@id='textAnswer']/../../../..//p")   
	public static List<WebElement> lblText;
	
	@FindBy(xpath="//ul[@id='notSubmitted']/li/select")
	public static List<WebElement> drpdwnSelect;
	...
	@FindBy(xpath="//ul[1]/li/product/expandable//ul[2]//button")
	public static List <WebElement> btnExpandsubs;
	
	@FindBy(xpath="//tab[4]//ul[1]/li/product//div/button")
	public static List <WebElement> btnExpands;
	...
	@FindBy(xpath="//tab[4]//product//div/div/ul[2]/li//button")
	public static List <WebElement> expandBtn3;
	
	@FindBy(xpath="//span[text()='PPC']/../button/span")
	public static WebElement btnPPC;
	
	@FindBy(xpath="//span[text()='PPC']/../button/span")
	public static List <WebElement> btnPPClst;
	...
	@FindBy(xpath="//div[contains(text(),'Select Multiple')]")
	public static WebElement drpdwnSelectMult;
