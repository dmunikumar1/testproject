...
public class EsignProcessPageObjects {
	...
	@FindBy(xpath="//div[@id='documents']/div/div[2]/div[1]/div[3]/div[2]/input")
	public static WebElement txtTitle;
	
	@FindBy(xpath="//div[@id='documents']//div/div[3]/div//div/div[2]/input")
	public static WebElement txtTitle1;
	
	@FindBy(xpath="//div[@id='documents']/div/div[1]/div[1]/div[3]/div[2]/input")
	public static WebElement txtTitle2;
	
	@FindBy(xpath="//div[@id='documents']//input")
	public static WebElement txtTitle3;
	...
	public static List<WebElement> btnNoThanks;
}
