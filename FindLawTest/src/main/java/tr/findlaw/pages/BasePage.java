...
public class BasePage {
	...
	public void loginWithValidUser() {
		String userName = ExcelUtils.getDataByColumnNameWithRowIndex("Login", "Username",2);
		String password = ExcelUtils.getDataByColumnNameWithRowIndex("Login", "Password",2);
	...
	public void Logout() {
		/*
		 * Use below line for LRP5QA env
		 */
		//driver.findElement(By.xpath("//div[@id='userNavButton']/div[1]")).click();
		/*
		 * Use below line for LRP1QA env
		 */
		elementHandler.clickElement(BasePageObjects.drpdwnLoginUser);
