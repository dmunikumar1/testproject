...
public class Sprint_20 extends FindlawBaseTest {
	...
	/*
	 * Take any Existing Account which is having any one of firmsite product as an asset and not having US PPC product.Add US PPC product:30010890.
	 ...
	 */
	     ...
	     public void soc_6442() {	 
				...
				accountpage.searchExistAccount(74);
